...
class MMIO {
    ...
    ubyte read(uint address) {
        switch (address) {
            ...
            // case WININ       + 0: return ppu.read_WININ(); 
    ...
    void write(uint address, ubyte data) {
        switch (address) {
            ...
            // case BG2X        + 0: ppu.write_BG2X(data); break;
            // case BG2X        + 1: ppu.write_BG2X(data); break;
            // case BG2X        + 2: ppu.write_BG2X(data); break;
            // case BG2X        + 3: ppu.write_BG2X(data); break;
            // case BG2Y        + 0: ppu.write_BG2Y(data); break;
            // case BG2Y        + 1: ppu.write_BG2Y(data); break;
            // case BG2Y        + 2: ppu.write_BG2Y(data); break;
            // case BG2Y        + 3: ppu.write_BG2Y(data); break;
            ...
            // case BG3X        + 0: ppu.write_BG3X(data); break;
            // case BG3X        + 1: ppu.write_BG3X(data); break;
            // case BG3X        + 2: ppu.write_BG3X(data); break;
            // case BG3X        + 3: ppu.write_BG3X(data); break;
            // case BG3Y        + 0: ppu.write_BG3Y(data); break;
            // case BG3Y        + 1: ppu.write_BG3Y(data); break;
            // case BG3Y        + 2: ppu.write_BG3Y(data); break;
            // case BG3Y        + 3: ppu.write_BG3Y(data); break;
            // case WIN0H       + 0: ppu.write_WIN0H(data); break;
            // case WIN0H       + 1: ppu.write_WIN0H(data); break;
            // case WIN1H       + 0: ppu.write_WIN1H(data); break;
            // case WIN1H       + 1: ppu.write_WIN1H(data); break;
            // case WIN0V       + 0: ppu.write_WIN0V(data); break;
            // case WIN0V       + 1: ppu.write_WIN0V(data); break;
            // case WIN1V       + 0: ppu.write_WIN1V(data); break;
            // case WIN1V       + 1: ppu.write_WIN1V(data); break;
            // case WININ       + 0: ppu.write_WININ(data); break;
            // case WININ       + 1: ppu.write_WININ(data); break;
            // case WINOUT      + 0: ppu.write_WINOUT(data); break;
